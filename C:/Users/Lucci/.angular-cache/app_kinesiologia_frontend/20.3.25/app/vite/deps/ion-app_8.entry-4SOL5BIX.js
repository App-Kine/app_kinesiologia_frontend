...
} from "./chunk-ILXTVQSG.js";
import {
  findIonContent,
  getScrollElement,
  printIonContentErrorMsg
} from "./chunk-JNW2ESJV.js";
import "./chunk-3PEYN766.js";
import {
  isRTL
} from "./chunk-62H7H4ZQ.js";
import {
  createLockController
} from "./chunk-3JG4NZ4Q.js";
import "./chunk-VTI63QVE.js";
import {
  getTimeGivenProgression
} from "./chunk-SBKTCMB6.js";
import {
  attachComponent,
  detachComponent
} from "./chunk-5Z524OBB.js";
import {
  createColorClasses,
  hostContext
} from "./chunk-J7V34GLW.js";
import {
  getIonMode,
  isPlatform
} from "./chunk-PB254PH6.js";
import {
  shouldUseCloseWatcher
} from "./chunk-SUTVAEKD.js";
import {
  transition
} from "./chunk-E6M4VMD7.js";
import {
  clamp,
  componentOnReady,
  hasLazyBuild,
...
} from "./chunk-LQTPGZP7.js";
import "./chunk-SVWIQ6HU.js";
import {
  Host,
  config,
  createEvent,
  ...
  componentDidLoad() {
    {
      this.rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-BtUdxPjv-2WJSEIM6.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-BfJqFSLF-OPMZNZ2H.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-AaDhOpKN-GACA642J.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./hardware-back-button-CTe4XmL7-MY7P7P6D.js");
        ...
        if (typeof window !== "undefined") {
          import("./keyboard-ywgs5efA-UID77IZL.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./focus-visible-BmVRXR1y-XVMPVCXF.js").then((module) => this.focusVisible = module.startFocusVisible());
      }));
    }
  }
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./swipe-back-BZBFwTQV-2PUOVQST.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
//# sourceMappingURL=ion-app_8.entry-4SOL5BIX.js.map
