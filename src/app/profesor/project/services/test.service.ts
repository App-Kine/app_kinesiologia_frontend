...
export class TestService extends BaseService {
   ...
   * hay más. El backend devuelve { items, page, pageSize, hasMore }. Usar esto
   * en listados que pueden crecer (banco de tests del profesor).
   */
  async listarPagina(
    page = 1,
    pageSize = 20,
