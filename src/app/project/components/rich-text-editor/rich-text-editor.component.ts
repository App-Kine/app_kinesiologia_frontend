import {
  ...
  Input, OnChanges, Output, SimpleChanges, ViewChild, forwardRef,
} from '@angular/core';
...
export class RichTextEditorComponent implements ControlValueAccessor, AfterViewInit, OnChanges {
  ...
  ngOnChanges(ch: SimpleChanges): void {
    if (ch['value'] && !ch['value'].firstChange) {
      ...
      if (incoming !== this.editor.nativeElement.innerHTML) {
